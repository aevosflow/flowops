              ...
              <Card key={item.id} className="flex flex-col p-4 sm:p-5">
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-red-500/30 py-1.5 text-xs font-semibold text-red-400 transition-colors hover:bg-red-500/10 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-emerald-500 py-1.5 text-xs font-semibold text-black transition-colors hover:bg-emerald-400 disabled:opacity-50"
                  >
